 ...
 * 
 * @author xujinfengxu
 * Student_db operation
 */
public class StudentDao extends BaseDao {
	public boolean addStudent(Student student) {
		String sql = "INSERT into s_student values(null,'" + student.getName() + "','" + student.getSn() + "'";
		sql += ",'" + student.getPassword() + "','" + student.getClazzId() + "',null)";
		return update(sql);
	}
	...
	public Student getStudentbypwd(String pwd){
		String sql = "select * from s_student where password = " + pwd;
		Student student = null;
		ResultSet resultSet = query(sql);
		try {
			if(resultSet.next()){

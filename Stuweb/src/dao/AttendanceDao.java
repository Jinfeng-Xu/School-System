...
public class AttendanceDao extends BaseDao {
	...
	public boolean addAttendance(Attendance attendance){
		String sql = "insert into s_attendance values(null,"+attendance.getCourseId()+","+attendance.getStudentId()+",'"+attendance.getType()+"','"+attendance.getDate()+"','"+attendance.getCourseDate()+"')";
		return update(sql);
	}
	...
	public List<Attendance> getSelectedCourseList(Attendance attendace,Page page){
		...
		if(!StringUtil.isEmpty(attendace.getCourseDate())){
			sql += " and course_date = '" + attendace.getCourseDate() + "'";
		}
		...
		try {
			while(resultSet.next()){
				...
				a.setCourseDate(resultSet.getString("course_date"));
				ret.add(a);
			}
		} catch (SQLException e) {
			// TODO Auto-generated catch block
